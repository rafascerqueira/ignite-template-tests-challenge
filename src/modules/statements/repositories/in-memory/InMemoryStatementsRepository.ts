...
import { ITransferBetweenAccountsDTO } from "../../useCases/transferBetweenAccounts/ITransferBetweenAccountsDTO";
...
export class InMemoryStatementsRepository implements IStatementsRepository {
  ...
  async transferValueBetweenAccounts({
    sender_id,
    id,
    amount,
    description,
    ...
    Object.assign(transfer, { sender_id, id, amount, description, type });
